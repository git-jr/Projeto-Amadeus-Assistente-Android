...
public class EditarItemEntidadeNovoActivityJava extends AppCompatActivity implements DialogSimples.FragmentDialogInterface {
    ...
    public void abrirDialogEditar(Integer posi, boolean editando) {
        ...
        botaoNegar.setOnClickListener(view -> {
            esconderTeclado(view, EditarItemEntidadeNovoActivityJava.this);
