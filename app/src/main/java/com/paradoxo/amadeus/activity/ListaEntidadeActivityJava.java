...
public class ListaEntidadeActivityJava extends AppCompatActivity implements DialogSimples.FragmentDialogInterface {
        ...
        recyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(@NonNull RecyclerView recyclerView, int newState) {
                ...
                if (posiUltimoItem == limiteCarregarItensRecycler - 1) {
                    ...
                    carregaSentencaBanco(ListaEntidadeActivityJava.this);
                }
