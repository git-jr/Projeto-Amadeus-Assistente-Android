...
public class SobreActivityJava extends AppCompatActivity {
    ...
    private void configurarClikLicencas() {
        findViewById(R.id.licencaCodigoLayout).setOnClickListener(v -> startActivity(new Intent(SobreActivityJava.this, OssLicensesMenuActivity.class)));
    }
}
