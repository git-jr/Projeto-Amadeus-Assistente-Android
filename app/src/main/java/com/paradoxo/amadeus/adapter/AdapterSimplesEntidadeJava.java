...
public class AdapterSimplesEntidadeJava extends RecyclerView.Adapter<AdapterSimplesEntidade.ViewHolder> {
    List<Entidade> itens;
    ...
    public AdapterSimplesEntidadeJava(List<Entidade> itens) {
        this.itens = itens;
    }
