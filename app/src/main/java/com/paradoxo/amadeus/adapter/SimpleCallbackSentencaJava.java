...
public class SimpleCallbackSentencaJava extends ItemTouchHelper.SimpleCallback {
    ...
    public SimpleCallbackSentencaJava(AdapterSimples adapter, Context context) {
