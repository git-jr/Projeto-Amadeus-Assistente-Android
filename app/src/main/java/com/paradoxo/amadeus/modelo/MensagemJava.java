...
public class MensagemJava {
    ...
    public MensagemJava(int id, String conteudo, Autor autor, Date data, int idResposta) {
        this.id = id;
    ...
    public MensagemJava(int id, String conteudo, Autor autor, Date data) {
        this.id = id;
        this.conteudo = conteudo;
        this.autor = autor;
        this.data = data;
    ...
    public MensagemJava(String conteudo, Autor autor) {
        this.conteudo = conteudo;
        this.autor = autor;
    }

    protected MensagemJava(Parcel in) {
        id = in.readInt();
        conteudo = in.readString();
    }

    public MensagemJava(int id){
        this.id = id;
    }

    public MensagemJava(String conteudo, String conteudo_resposta) {
        this.conteudo = conteudo;
        this.conteudo_resposta = conteudo_resposta;
    }

    public MensagemJava(boolean progresso, Autor autor) {
