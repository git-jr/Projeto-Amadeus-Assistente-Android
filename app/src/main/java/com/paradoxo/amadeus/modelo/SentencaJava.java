...
public class SentencaJava {
    ...
    public SentencaJava(String output, String chave) {
        this.respostas.add(output);
        this.chave = chave;
    }

    public SentencaJava(String output, String chave, AcaoEnum acao, int tipo_item) {
        this.respostas.add(output);
        this.chave = chave;
        this.acao = acao;
    ...
    public SentencaJava(String chave) {
        this.respostas.add(0,chave);
    }

    public SentencaJava(String entrada, int tipo_item) {
        this.respostas.add(0,entrada);
        this.tipo_item = tipo_item;
    }

    public SentencaJava(int tipo_item) {
        this.tipo_item = tipo_item;
    }

    public SentencaJava(String entrada, AcaoEnum acaoEnum) {
        this.respostas.add(0,entrada);
        this.acao = acaoEnum;
    }
